...
_STR = {
    ...
    "btn_view_diff": {"zh": "🔍 查看改动", "en": "🔍 View Diff"},
    "btn_ai_review": {"zh": "🤖 AI预审", "en": "🤖 AI Review"},
    "btn_dag_board": {"zh": "📊 DAG 看板", "en": "📊 DAG Board"},
    "btn_conflict_ai": {"zh": "⚡ AI 冲突诊断", "en": "⚡ AI Conflict Diagnosis"},
    "diff_window_title": {"zh": "任务代码差异查看", "en": "Task Code Diff Viewer"},
    "diff_base_commit": {"zh": "基准提交", "en": "Base Commit"},
    "diff_files_stat": {"zh": "变更文件统计", "en": "Changed Files Stat"},
    "diff_no_changes": {"zh": "未检测到任何代码变更", "en": "No code changes detected"},
    "diff_truncated": {"zh": "差异内容过长，仅展示前 {limit} 行（共 {total} 行）", "en": "Diff too large, showing first {limit} lines (total {total} lines)"},
    "ai_review_window_title": {"zh": "AI 代码审查建议", "en": "AI Code Review"},
    "ai_review_verdict": {"zh": "审查结论", "en": "Review Verdict"},
    "ai_review_analyzing": {"zh": "正在分析任务代码与测试...", "en": "Analyzing task code and tests..."},
    "dag_window_title": {"zh": "任务依赖与编排拓扑", "en": "Task Dependencies & DAG Topology"},
    "conflict_window_title": {"zh": "合并冲突诊断与解决引导", "en": "Merge Conflict Diagnosis & Resolution"},
    "lbl_dependencies": {"zh": "前置依赖", "en": "Dependencies"},
    "lbl_no_dependencies": {"zh": "无依赖 (就绪)", "en": "No dependencies (Ready)"},
    "lbl_blocked_by_parent": {"zh": "等待前置: {deps}", "en": "Blocked by: {deps}"},
    "ctx_view_diff": {"zh": "🔍 查看代码 Diff", "en": "🔍 View Code Diff"},
    "ctx_ai_review": {"zh": "🤖 运行 AI 预审", "en": "🤖 Run AI Review"},
    "ctx_copy_id": {"zh": "📋 复制任务 ID", "en": "📋 Copy Task ID"},
    "ctx_copy_prompt": {"zh": "📋 复制 Agent 提示词", "en": "📋 Copy Agent Prompt"},
    "ctx_open_ws": {"zh": "📂 打开工作区目录", "en": "📂 Open Workspace Directory"},
